...
<li>
   <a class="button" href="javascript:FFESSM_Insc('{$member->login}','{$member->_name}','{$member->_surname}','{$member->_birthdate}')" id="btn_plugins_ffessmid_inscript" title="Inscrire cet adhérent via le site de la FFESSM (2018).">Inscription 2018<!-- {_T string="Inscription FFESSM 2018"} --></a>
</li>
{/if}